        ...
        <li>
            ...
            <div class="timeline-body">
                ...
                <div class="timeline-comment-box">
                    ...
                    <div class="input">
                        <form action="">
                            <textarea type="text" class="form-control rounded-corner">What is on your mind?</textarea>
                            <span class="input-group-btn p-l-10">
                                <button class="btn btn-primary f-s-12 rounded-corner" type="button">Post</button>
                            </span>
                        </form>
                    </div>
                </div>
